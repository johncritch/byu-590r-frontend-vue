...
export const user = {
	...
	actions: {
		...
		addDeviceToCollection({ commit }, deviceId) {
			return userService.addDeviceToCollection(deviceId)
		},
		removeDeviceFromCollection({ commit }, deviceId) {
			return userService.removeDeviceFromCollection(deviceId)
		}
	},
	mutations: {
		setUser(state, user) {
